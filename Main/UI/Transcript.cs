...
namespace FoenixIDE.Simulator.UI
{
    class TranscriptDebugLine 
    {
        ...
        public TranscriptDebugLine(int pc, int a, int x, int y, FoenixIDE.Processor.Flags p)
        {
            PC = pc;
            A = a;
            X = x;
    ...
    public class Transcript
    {
        ...
        void UpdateDebugWindowHeader()
        {
            ...
            {
                HeaderTextbox.Text = "PC      OPCODES      DISASSEMBLY    REGISTERS";
            }
            else
            {
            ...
            WriteToTranscriptEnablement writeToTranscriptEnablement)
        {
            ...
            TranscriptDebugLine transcriptLine = GetDebugLineFromPC();
        ...
        TranscriptDebugLine GetDebugLineFromPC()
        {
            TranscriptDebugLine line = null;
            ...
            line = new TranscriptDebugLine(Kernel.CPU.PC, Kernel.CPU.A.Value, Kernel.CPU.X.Value, Kernel.CPU.Y.Value, Kernel.CPU.P);
